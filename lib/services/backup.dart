    ...
    await _db.transaction(() async {
      ...
      for (final t in tasks) {
        await _db.into(_db.tasks).insert(TasksCompanion(
              ...
              dependsBefore: Value((t['dependsBefore'] as bool?) ?? false),
              ...
              noteCategory: Value(t['noteCategory'] as int? ?? -1),
              author: Value(t['author'] as String? ?? ''),
              year: Value(t['year'] as int?),
              audience: Value(t['audience'] as int? ?? 0),
